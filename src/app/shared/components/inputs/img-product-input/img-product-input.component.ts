...
@Component({
  selector: 'app-img-product-input',
  templateUrl: './img-product-input.component.html',
  styleUrls: ['./img-product-input.component.scss'],
  imports: [ImageCropperComponent]
})
export class ImgProductInputComponent implements OnInit {
